...
namespace Common
{
    ...
    public class CookieHelper
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static UserInfo GetUserInfoCookie()
        {
            if (HttpContext.Current.Request.Cookies["userName"]!=null&& HttpContext.Current.Request.Cookies["userPwd"]!=null)
            {
                string userName = HttpContext.Current.Request.Cookies["userName"].Value;
                string userPwd = HttpContext.Current.Request.Cookies["userPwd"].Value;
                return AbstractFactory.GetUserInfoService().CheckUser(userName, userPwd);
            }
